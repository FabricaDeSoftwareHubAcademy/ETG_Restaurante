...
<section class="section_modal"> 
    ...
    <div class="modal-box">
        ...
        <h2 class="titulo_pop_up">Concluido</h2>
            <h3 class="subtitulo_pop_up">Usuário Excluido com Sucesso!</h3>
...
.close-btn{
    ...
    <script>
           ...
           // const showModalBtn = document.querySelector('.show-modal');
            ...
            const modalTeste = document.querySelector('.modal-box');
            function openModalTeste() {
                overlay.style.opacity = '1';
                overlay.style.pointerEvents = 'auto';
                modalTeste.style.opacity = '1';
                modalTeste.style.pointerEvents = 'auto';
            }
            function closeModalTeste() {
                overlay.style.opacity = '0';
                overlay.style.pointerEvents = 'none';
                modalTeste.style.opacity = '0';
                modalTeste.style.pointerEvents = 'none';
            }
            //showModalBtn.addEventListener('click', openModal); 
            closeModalBtn.addEventListener('click', closeModalTeste);
            openModalBtn.addEventListener('click', openModalTeste);
