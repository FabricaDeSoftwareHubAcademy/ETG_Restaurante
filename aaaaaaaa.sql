...
INSERT INTO `cadastro_checklist` VALUES (1,'Checklist I'),(2,'lucas');
...
INSERT INTO `cadastro_perfil` VALUES (1,'Administrador','1','1','1','1','1','1','1','1','1'),(2,'Logistica','0','0','0','0','1','1','1','0','0'),(4,'Estagio ','1','1','1','1','1','1','1','1','1'),(7,'Teste','0','0','0','0','1','1','1','0','0'),(8,'Belzebu','1','1','1','1','1','1','1','1','1'),(9,'Zé ninguém ','0','0','0','0','0','0','0','0','1');
...
INSERT INTO `cadastro_pergunta` VALUES (1,'Pergunta I','0'),(2,'Pergunta II','1'),(3,'uiowhaod','2');
...
CREATE TABLE `cadastro_sala` (
  ...
  `img_sala` varchar(80) DEFAULT NULL,
  `descricao` text,
...
INSERT INTO `cadastro_sala` VALUES (1,'Sala i','1','#ff0000','65b17407bb0f3.jpg-vs-jpeg.65b17407bb0f3.jpg','Skadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadldsaskadld','L','{\"sexta\": \"sim\", \"terca\": \"sim\", \"quarta\": \"sim\", \"quinta\": \"sim\", \"sabado\": \"sim\", \"turnos\": {\"noturno\": \"sim\", \"matutino\": \"sim\", \"vespertino\": \"sim\"}, \"segunda\": \"sim\"}',1);
...
INSERT INTO `cadastro_usuario` VALUES (1,'adm','adm@gmail.com','4','123',1,'65aac03e7b5f5-sasuke.jpeg'),(22,'Thays','thaysempaz@gmail.com','123','123',1,'profile.png'),(23,'zuints','zuints@gmail.com','321','321',9,'profile.png'),(24,'zoro','zoro@gmail.com','2','123',1,'65b172cdee0a7-zoro.png');
...
INSERT INTO `check_aberta` VALUES (1,1),(2,2),(3,3),(4,4);
...
INSERT INTO `notificacao` VALUES (1,1,22,'Olá Thays, você está em paz?','2024-01-24 18:43:17','1','1'),(2,1,22,'Olá ','2024-01-24 18:43:59','1','0'),(3,1,1,'Leu logo gay','2024-01-24 20:37:28','1','1'),(4,1,1,'TESTE NOTIFAACAO LUIZ\r\n','2024-01-24 20:41:09','1','0');
...
INSERT INTO `recados` VALUES (2,1,'dwad','2024-01-24 18:26:40');
...
INSERT INTO `relacao_pergunta_checklist` VALUES (1,1,3),(2,1,1),(3,1,3),(4,1,2),(5,1,1),(6,2,6),(7,2,4),(8,2,6),(9,2,5),(10,3,4),(11,3,3),(12,3,5),(13,3,2),(14,4,9),(15,4,4),(16,4,1),(17,4,8),(18,4,6),(19,4,4),(20,4,3),(21,4,2),(22,5,9),(23,5,7),(24,5,8),(25,5,7),(26,6,9),(27,6,8),(28,6,7),(29,7,9),(30,7,8),(31,7,7),(32,8,9),(33,8,8),(34,8,7),(35,9,9),(36,9,8),(37,9,7),(38,10,9),(39,10,8),(40,11,9),(41,11,8),(42,12,9),(43,12,7),(44,12,8),(45,12,7),(46,13,9),(47,13,8),(48,14,9),(49,14,7),(50,14,8),(51,14,7),(52,15,9),(53,15,8),(54,16,9),(55,16,7),(56,16,4),(57,16,6),(58,1,1),(59,1,2),(60,2,3),(61,2,3);
...
INSERT INTO `responder_check` VALUES (1,1,3,'2024-01-24 19:02:33',NULL,'n'),(2,1,2,'2024-01-24 19:19:46',NULL,'n'),(3,1,3,'2024-01-24 19:20:35','2024-01-24 22:27:46','n'),(4,1,3,'2024-01-24 19:27:59','2024-01-24 22:28:07','n');
...
/*!50001 VIEW `check_concluidas` AS select `responder_check`.`id` AS `id_responder`,`responder_check`.`data_abertura` AS `data_abertura`,`responder_check`.`data_fechamento` AS `data_fechamento`,`check_aberta`.`id_reg` AS `id_aberto`,`cadastro_sala`.`nome` AS `nome_sala`,`cadastro_sala`.`img_sala` AS `img_sala` from ((`responder_check` join `check_aberta` on((`check_aberta`.`id_reg` = `responder_check`.`id`))) join `cadastro_sala` on((`responder_check`.`id_sala` = `cadastro_sala`.`id`))) order by `responder_check`.`data_fechamento` */;
...
-- Dump completed on 2024-01-24 17:30:56
